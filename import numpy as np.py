...
import math
##  AINDA É NECESSÁRIO REFATORAR ESSE CÓDIGO  ##
class Arrefecimento():
...
freio_1 = Arrefecimento(a_freio,rho,c_ar,temp_ar,temp_freio,v,ni,k_ar,mi,massa_freio,temp_ideal_f,c_freio)                 # Definição do objeto para freio
